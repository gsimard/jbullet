...
public class GeometryUtil {
	...
	public static void getPlaneEquationsFromVertices(ObjectArrayList<Vector3d> vertices, ObjectArrayList<Vector4d> planeEquationsOut) {
		Vector4d planeEquation = Stack.alloc(Vector4d.class);
		Vector3d edge0 = Stack.alloc(Vector3d.class), edge1 = Stack.alloc(Vector3d.class);
	...
	public static void getVerticesFromPlaneEquations(ObjectArrayList<Vector4d> planeEquations, ObjectArrayList<Vector3d> verticesOut) {
		Vector3d n2n3 = Stack.alloc(Vector3d.class);
		Vector3d n3n1 = Stack.alloc(Vector3d.class);
		Vector3d n1n2 = Stack.alloc(Vector3d.class);
		Vector3d potentialVertex = Stack.alloc(Vector3d.class);
